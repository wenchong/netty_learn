...
public class NioTest12 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0 ; i < ports.length;i++){
            ...
            System.out.println("链接端口" + ports[i]);
        }
        ...
        while(true){
            ...
            System.out.println("selectorKeys " + selectorKeys);
            ...
            while (iter.hasNext()){
                ...
                if (selectorKey.isAcceptable()){
                    ServerSocketChannel serverSocketChannel = (ServerSocketChannel)selectorKey.channel();
                    ...
                    System.out.println("获取客户但链接 : " + socketChannel);
